...
i = 1
def click(x, y):
    global draw, text1, i, button_clicked, button, turn, check_win, check_lose, win, lose
    if win == True:
        clear()
        text1.clear()
        text1.goto(-100, 0)
        text1.write('You Won', font=("Arial", 50, "bold"))
    elif lose == True:
        clear()
        text1.clear()
        text1.goto(-130, 0)
        text1.write('You Lost', font=("Arial", 50, "bold"))
    else:
        if draw == False:
